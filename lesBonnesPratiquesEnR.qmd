...
## Ne pas enregistrer les données dans un fichier `.RData` à la fermeture d'une session
...
## Apprendre à bien gérer `GIT` avec `RStudio`
...
## Enregistrer régulièrement ses fichiers
